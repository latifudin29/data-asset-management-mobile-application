...
class EditInventoryFScreen extends StatefulWidget {
  const EditInventoryFScreen({super.key});

  @override
  State<EditInventoryFScreen> createState() => _EditInventoryFScreenState();
}

class _EditInventoryFScreenState extends State<EditInventoryFScreen> {
